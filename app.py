...
def fetch_data(min_price, max_price, min_area, max_area):
    all_data = []
    for page in range(1, 9):  # 최대 8페이지 (20건 * 8 = 160건)
        url = (
        ...
        if res.status_code == 200:
            try:
                ...
                for a in articles:
                    a["매물링크"] = f'<a href="https://new.land.naver.com/houses?articleNo={a["articleNo"]}" target="_blank">🔗 바로가기</a>'
